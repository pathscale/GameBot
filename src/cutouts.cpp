...
const FeatureDescList cutouts {
    ...
    _F("AS4",   "AirSweeper4",   _SINGLE("defense/as4.png",      pos(0, 0),      0.92),  0,  2, Defense(0, 15, 0, Defense::PUSH, Defense::AIR)), // It can be rotated 45 degrees at a time, and hence has 8 rigid directional settings. The Air Sweeper attacks in a rectangular area of effect of width 5 tiles and length 14. (http://clashofclans.wikia.com/wiki/Air_Sweeper)
            // TODO: decrease threshold to ~0.9 after UI is masked out to gain obscured detection
    _F("CA13",  "Cannon13",      _SINGLE("defense/ca13_2.png",   pos(0, 0),      0.92), 0,  3, Defense(0, 9, 0, Defense::SINGLE, Defense::GROUND)),
    ...
    _F("DD6",   "DarkDrill6",    _S({_I("storage/dd6.png",      pos(0, 0),      0.97),
                                     _I("storage/dd6_1.png",    pos(0, 0),      0.95)}), 0,  3, Building(0)),
    _F("GM12",  "GoldMine12",    _SINGLE("storage/gm12.png",     pos(0, 0),      0.95),  0,  3, Building(0)),

    _F("GS11-0","GoldStor11",   _SINGLE("storage/gold11base.png",pos(0, 0),      0.95),  0,  3, Storage(0, Storage::GOLD, 0)), // FIXME: health, offset, amount
